...
public class TypeConvertUtil {
	...
	public static Object convert(Object obj, String type, String format) throws Exception  {
		...
		if (obj instanceof String) {
			...
			if ("Double".equals(type) || "java.lang.Double".equals(type))
				try {
					...
					throw new Exception("Could not convert " + str + " to " + type + ". ", e);
				}
			...
			if ("Timestamp".equals(type) || "java.sql.Timestamp".equals(type)) {
				...
				throw new Exception("Conversion from " + fromType + " to " + type
		...
		if ("String".equals(type) || "java.lang.String".equals(type))
			...
			throw new Exception("Conversion from " + obj.getClass().getName() + " to " + type
					+ " not currently supported");
	}
	...
	public static Date convert2SqlDate(Object obj, String format) throws Exception {
