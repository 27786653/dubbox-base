...
*/
@Controller
@RequestMapping("/wymanagement")
public class WyManagementController {
	@Autowired
	private WyManagementFacade wyManagementFacade;
	
	@RequestMapping(params="index")
    public ModelAndView index(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ModelAndView ret = new ModelAndView("modules/manager/manager-list");
        return ret;
    }
    ...
    public dtData datagird(HttpServletRequest request,
        ...
        dtData obj = this.wyManagementFacade.datagrid(md, curPage, pageSize);
		return obj;
    }
    ...
    public ModelAndView update(HttpServletRequest request,HttpServletResponse response,String id) throws Exception {
		...
		ModelAndView ret = new ModelAndView("modules/manager/manager-update");
        return ret;
    }
}