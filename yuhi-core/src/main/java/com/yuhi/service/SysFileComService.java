...
import com.yuhi.base.dao.SysFileComDao;
...
public class SysFileComService {
    ...
    * @throws Exception
    */
public JSONObject put(String key, String type, String userId, File upfile, Date expired, String descInfo) throws Exception {
        
    	String filename = upfile.getName();
    	String extName = getExtName(filename);
    	String fileId = FastDFSClientUtils.upload(upfile, extName);
    	String dataGroup = fileId.substring(0,fileId.indexOf("/"));
        ...
        ret.put("key", key);
        ret.put("type", type);
        ret.put("name", upfile.getName());
        ret.put("bytes", upfile.length());
        ret.put("dataPath", FASTDFS_BASEURL + fileId);
        ret.put("dataGroup", dataGroup);
        ret.put("expired", expired);
        return ret;
